<h1 align="center">Hey!👋, this is Hardik</h1>
<h3 align="center">I am Upcoming Developer</h3>

- 💻 learning and creating web apps using `MERN`.
- 🐬 Learning And practicing `DSA`.
- 🐍 Loves to Code In `Python` and `Java`.
- 😍 Having a keen interest in `Machine Learning`.
- 📈 Also focussed on improving my `Problem-Solving Skills`.
...
<p align="left">
<a href="https://www.linkedin.com/in/hardik0702" target="blank"><img align="center" src="https://cdn.worldvectorlogo.com/logos/linkedin-icon-2.svg" alt="" height="30" width="40" /></a>
</p>


[![](https://visitcount.itsvg.in/api?id=Hardik0702&icon=0&color=1)](https://visitcount.itsvg.in)
